...
public class BGLSNavigationController {
	...
	public String SubmitcollamanageModify( // Change parameter name to user_id
		...
		if (existed == null) {
			...
			System.out.println(collateral_management_Entity.getCustomer_id()); // Changed to user_id
